$(function () {
    ...
    newCatA.click(function (e) {
        ...
        if (catName.length < 3) {
            alert("Название категории должно иметь больше 3 символов.");
            return false;
        }
        ...
        $.post(url, { catName: catName }, function (data) {
            ...
            if (response == "titletaken") {
                ajaxText.html("<span class='alert alert-danger'>Данное название уже существует!</span>");
                setTimeout(function () {
                    ajaxText.fadeOut("fast", function () {
                        ajaxText.html("<img src='/Content/img/25.gif' height='50' />");
                    });
                }, 2000);
                return false;
            }
    ...
    $("table#pages input.text-box").blur(function () {
        ...
        $.post(url, { newCatName: newCatName, id: id }, function (data) {
            ...
            if (response == "titletaken") {
                ...
                ajaxdiv.html("<div class='alert alert-danger'>Данное название уже существует!</div>").show();
            }
            else {
                ajaxdiv.html("<div class='alert alert-success'>Категория добавлена!</div>").show();
            }
    ...
    $("table#pages tbody").sortable({
        ...
        update: function () {
            ...
            var url = "Admin/Shop/RecoderCategories";
